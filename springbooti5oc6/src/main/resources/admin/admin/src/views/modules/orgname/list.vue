  ...
  methods: {
    ...
    getDataList() {
      ...
      if (this.searchForm.name) {
        let id = this.dataList.find((item) => {
          return item.name == this.searchForm.name;
        }).id;

        if (id) {
          params['department'] = { id:id, name: this.searchForm.name,createtime:null };
        } else {
