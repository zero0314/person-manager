	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'" label="销假编号" prop="xiaojiabianhao">
					<el-input v-model="ruleForm.xiaojiabianhao" placeholder="销假编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.xiaojiabianhao" label="销假编号" prop="xiaojiabianhao">
					<el-input v-model="ruleForm.xiaojiabianhao" placeholder="销假编号" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="销假时间" prop="xiaojiashijian">
					<el-date-picker
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.xiaojiashijian" label="销假时间" prop="xiaojiashijian">
					<el-input v-model="ruleForm.xiaojiashijian" placeholder="销假时间" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="销假备注" prop="xiaojiabeizhu">
					<el-input v-model="ruleForm.xiaojiabeizhu" placeholder="销假备注" clearable  :readonly="ro.xiaojiabeizhu"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="销假备注" prop="xiaojiabeizhu">
					<el-input v-model="ruleForm.xiaojiabeizhu" placeholder="销假备注" readonly></el-input>
				</el-form-item>
			</template>
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='xiaojiabeizhu'){
							this.ruleForm.xiaojiabeizhu = obj[o];
							this.ro.xiaojiabeizhu = true;
							continue;
						}
				}
