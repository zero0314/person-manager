<template>
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="select" v-if="type!='info'" label="员工工号" prop="yuangonggonghao">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.yuangonggonghao" label="员工工号" prop="yuangonggonghao">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="部门" prop="bumen">
					<el-input v-model="ruleForm.bumen" placeholder="部门" clearable  :readonly="ro.bumen"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="部门" prop="bumen">
					<el-input v-model="ruleForm.bumen" placeholder="部门" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="岗位" prop="gangwei">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="培训日期" prop="peixunriqi">
					<el-date-picker
						format="yyyy 年 MM 月 dd 日"
						value-format="yyyy-MM-dd"
						v-model="ruleForm.peixunriqi" 
						type="date"
						:readonly="ro.peixunriqi"
						placeholder="培训日期"
					></el-date-picker> 
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.peixunriqi" label="培训日期" prop="peixunriqi">
					<el-input v-model="ruleForm.peixunriqi" placeholder="培训日期" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="培训天数" prop="peixuntianshu">
					<el-input v-model="ruleForm.peixuntianshu" placeholder="培训天数" clearable  :readonly="ro.peixuntianshu"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="培训天数" prop="peixuntianshu">
					<el-input v-model="ruleForm.peixuntianshu" placeholder="培训天数" readonly></el-input>
				</el-form-item>
			</template>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-if="type!='info'"  label="培训内容" prop="peixunneirong">
					<editor 
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else-if="ruleForm.peixunneirong" label="培训内容" prop="peixunneirong">
                    <span :style='{"fontSize":"14px","lineHeight":"40px","color":"#000","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.peixunneirong"></span>
                </el-form-item>
...
export default {
	data() {
		...
		return {
			...
			rules: {
				...
				peixuntianshu: [
					{ required: true, message: '培训天数不能为空', trigger: 'blur' },
				],
				peixunneirong: [
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='peixunriqi'){
							this.ruleForm.peixunriqi = obj[o];
							this.ro.peixunriqi = true;
							continue;
						}
						if(o=='peixuntianshu'){
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.peixunneirong = this.ruleForm.peixunneirong.replace(reg,'../../../springbooti5oc6/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `peixunxuexi/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.peixunxuexiCrossAddOrUpdateFlag = false;
						 this.parent.search();
