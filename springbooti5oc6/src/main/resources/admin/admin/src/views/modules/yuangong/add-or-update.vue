	...
	<div class="addEdit-block" style="width: 100%;">
        ...
        >
          ...
          ></el-input>
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="毕业院校" prop="biyeyuanxiao">
					<el-input v-model="ruleForm.biyeyuanxiao" placeholder="毕业院校" clearable  :readonly="ro.biyeyuanxiao"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="毕业院校" prop="biyeyuanxiao">
