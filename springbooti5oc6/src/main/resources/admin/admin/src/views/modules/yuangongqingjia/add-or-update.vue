	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="请假类型" prop="qingjialeixing">
					<el-input v-model="ruleForm.qingjialeixing" placeholder="请假类型" clearable  :readonly="ro.qingjialeixing"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="请假类型" prop="qingjialeixing">
					<el-input v-model="ruleForm.qingjialeixing" placeholder="请假类型" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="起始时间" prop="qishishijian">
					<el-date-picker
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.qishishijian" label="起始时间" prop="qishishijian">
					<el-input v-model="ruleForm.qishishijian" placeholder="起始时间" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="截止时间" prop="jiezhishijian">
					<el-date-picker
						value-format="yyyy-MM-dd HH:mm:ss"
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.jiezhishijian" label="截止时间" prop="jiezhishijian">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else-if="ruleForm.qingjiayuanyin" label="请假原因" prop="qingjiayuanyin">
					<span :style='{"fontSize":"14px","lineHeight":"40px","color":"#000","fontWeight":"500","display":"inline-block"}'>{{ruleForm.qingjiayuanyin}}</span>
				</el-form-item>
		...
		init(id,type) {
			...
			this.$http({
				...
				if (data && data.code === 0) {
					...
					if(((json.gangwei!=''&&json.gangwei) || json.gangwei==0) && this.$storage.get("role")!="管理员"){
