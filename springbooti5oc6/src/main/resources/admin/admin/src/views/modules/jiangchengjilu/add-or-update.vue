	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="奖惩名称" prop="jiangchengmingcheng">
					<el-input v-model="ruleForm.jiangchengmingcheng" placeholder="奖惩名称" clearable  :readonly="ro.jiangchengmingcheng"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="奖惩名称" prop="jiangchengmingcheng">
					<el-input v-model="ruleForm.jiangchengmingcheng" placeholder="奖惩名称" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="奖惩类型" prop="jiangchengleixing">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="奖惩类型" prop="jiangchengleixing">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="textarea" v-if="type!='info'" label="奖惩原因" prop="jiangchengyuanyin">
					<el-input
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else-if="ruleForm.jiangchengyuanyin" label="奖惩原因" prop="jiangchengyuanyin">
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
                 ...
                 //信息放在ruleForm中，看ruleForm中是否有id,有id调用update操作(修改)，无id调用save操作(新增)
					 this.$http({
					   url: `jiangchengjilu/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 })
               .then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.jiangchengjiluCrossAddOrUpdateFlag = false;
						 this.parent.search();
