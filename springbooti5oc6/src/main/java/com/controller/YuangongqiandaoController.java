...
public class YuangongqiandaoController {
    ...
    public R page(@RequestParam Map<String, Object> params,YuangongqiandaoEntity yuangongqiandao,
		...
		if(tableName.equals("yuangong")) {
			yuangongqiandao.setYuangonggonghao((String)request.getSession().getAttribute("username"));
		}
        EntityWrapper<YuangongqiandaoEntity> ew = new EntityWrapper<YuangongqiandaoEntity>();
    ...
    public R info(@PathVariable("id") Long id){
        YuangongqiandaoEntity yuangongqiandao = yuangongqiandaoService.selectById(id);
    ...
    public R save(@RequestBody YuangongqiandaoEntity yuangongqiandao, HttpServletRequest request){
    	yuangongqiandao.setId(new Date().getTime()+new Double(Math.floor(Math.random()*1000)).longValue());
    	//ValidatorUtils.validateEntity(yuangongqiandao);
        yuangongqiandaoService.insert(yuangongqiandao);
        return R.ok();
    }
    ...
    public R update(@RequestBody YuangongqiandaoEntity yuangongqiandao, HttpServletRequest request){
        //ValidatorUtils.validateEntity(yuangongqiandao);
        yuangongqiandaoService.updateById(yuangongqiandao);//全部更新
        return R.ok();
    }
    ...
    public R delete(@RequestBody Long[] ids){
        yuangongqiandaoService.deleteBatchIds(Arrays.asList(ids));
        return R.ok();
    }
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<YuangongqiandaoEntity> wrapper = new EntityWrapper<YuangongqiandaoEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = yuangongqiandaoService.selectCount(wrapper);
