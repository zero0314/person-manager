...
public class QiuzhizheController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		QiuzhizheEntity u = qiuzhizheService.selectOne(new EntityWrapper<QiuzhizheEntity>().eq("qiuzhizhezhanghao", username));
    ...
    public R register(@RequestBody QiuzhizheEntity qiuzhizhe){
    	QiuzhizheEntity u = qiuzhizheService.selectOne(new EntityWrapper<QiuzhizheEntity>().eq("qiuzhizhezhanghao", qiuzhizhe.getQiuzhizhezhanghao()));
		if(u!=null) {
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<QiuzhizheEntity> wrapper = new EntityWrapper<QiuzhizheEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = qiuzhizheService.selectCount(wrapper);
